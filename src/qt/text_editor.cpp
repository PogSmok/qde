...
TextEditor::TextEditor(QWidget* parent) : QWidget(parent) {
 ...
 connect(editor_, &QPlainTextEdit::textChanged,
         this,    &TextEditor::onEditorTextChanged);

 connect(document_, &TextDocument::modifiedChanged,
         this,      &TextEditor::modifiedChanged);

 connect(document_, &TextDocument::filePathChanged,
         this,      &TextEditor::fileChanged);
...
bool TextEditor::saveFile() {
 if (filePath().isEmpty())
  return saveFileAs(QFileDialog::getSaveFileName(this, "Save File", {},
